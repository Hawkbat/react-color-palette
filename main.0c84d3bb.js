(function () {
	...
	*/
	...
	function useColor(format, initialColor) {
	  var getColor = react.useCallback(function () {
	    if (format === "hex") {
	      var _color = initialColor;
	      return toColor("hex", _color);
	    } else if (format === "rgb") {
	      var _color2 = initialColor;
	      return toColor("rgb", _color2);
	    } else if (format === "hsb") {
	      var _color3 = initialColor;
	      return toColor("hsb", _color3);
	    }

	    return toColor("hex", "#000000");
	  }, [format, initialColor]);

	  var _useState = react.useState(getColor),
	 ...
	 */
	function moveAt(x, y) {
	  var X = x.value - x.shift;
	  var newX = X < x.min ? x.min : X > x.max ? x.max : X;

	  if (y) {
	    var Y = y.value - y.shift;
	    var newY = Y < y.min ? y.min : Y > y.max ? y.max : Y;
	    return [newX, newY];
	  }
	...
	function getColorByCoordinates(h, x, y, width, height) {
	  var s = x / width * 100;
	  var b = y / height * 100;
	  return toColor("hsb", {
	    h: h,
	 ...
	 * @see [WHAT IS "COLOR"?](https://github.com/Wondermarin/react-color-palette#color)
	 */
	function getCoordinatesByColor(color, width, height) {
	  var _color$hsb = color.hsb,
	      s = _color$hsb.s,
	      b = _color$hsb.b;
	  var x = s / 100 * width;
	  var y = (100 - b) / 100 * height;
	  return [x, y];
	}
	 ...
	 * @param width The width of the canvas.
	 */
	function getHueByCoordinates(x, width) {
	  var h = x / width * 360;
	  return h;
	}
	 ...
	 * @param width The width of the canvas.
	 */
	function getCoordinatesByHue(h, width) {
	  var x = h / 360 * width;
	  return x;
	}
	 ...
	 * @param value Converted value.
	 */
	function toValidRGB(value) {
	  var rgb = value.map(function (v) {
	    if (Number(v) < 0) return 0;else if (Number(v) > 255) return 255;else return Number(v);
	  });
	  return {
	    r: rgb[0],
	    g: rgb[1],
	 ...
	 * @param value Converted value.
	 */
	function toValidHSB(value) {
	  var hsb = value.map(function (v, index) {
	    if (Number(v) < 0) return 0;else if (index === 0 && Number(v) > 360) return 360;else if (index !== 0 && Number(v) > 100) return 100;else return Number(v);
	  });
	  return {
	    h: hsb[0],
	    s: hsb[1],
	...
	var Saturation = function Saturation(_ref) {
	  var width = _ref.width,
	      height = _ref.height,
	      color = _ref.color,
	      onChange = _ref.onChange;
	  var saturationRef = react.useRef(null);
	  var position = react.useMemo(function () {
	    var _getCoordinatesByColo = getCoordinatesByColor(color, width, height),
	        _getCoordinatesByColo2 = _slicedToArray$3(_getCoordinatesByColo, 2),
	        x = _getCoordinatesByColo2[0],
	        y = _getCoordinatesByColo2[1];
	  ...
	  var moveCursor = function moveCursor(x, y, shiftX, shiftY) {
	    var _moveAt = moveAt({
	      value: x,
	      shift: shiftX,
	      min: 0,
	      ...
	      max: height
	        ...
	        _moveAt2 = _slicedToArray$3(_moveAt, 2),
	        newX = _moveAt2[0],
	        newY = _moveAt2[1];

	    var newColor = getColorByCoordinates(color.hsb.h, newX, newY, width, height);
	    onChange(newColor);
	  };
	  ...
	  var onMouseDown = function onMouseDown(e) {
	    if (saturationRef.current) {
	      ...
	      var saturation = saturationRef.current;
	      (_document$getSelectio = document.getSelection()) === null || _document$getSelectio === void 0 ? void 0 : _document$getSelectio.empty();

	      var _saturation$getBoundi = saturation.getBoundingClientRect(),
	          shiftX = _saturation$getBoundi.left,
	          shiftY = _saturation$getBoundi.top;
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("div", {
	    ...
	    style: {
	      height: height,
	      backgroundColor: "hsl(".concat(color.hsb.h, ", 100%, 50%)")
	    },
	...
	var Hue = function Hue(_ref) {
	  var width = _ref.width,
	      color = _ref.color,
	      onChange = _ref.onChange;
	  var hueRef = react.useRef(null);
	  var position = react.useMemo(function () {
	    var x = getCoordinatesByHue(color.hsb.h, width);
	    return x;
	  }, [color.hsb.h, width]);

	  var moveCursor = function moveCursor(x, shiftX) {
	    var _moveAt = moveAt({
	      value: x,
	      shift: shiftX,
	      min: 0,
	      max: width
	        ...
	        _moveAt2 = _slicedToArray$2(_moveAt, 1),
	        newX = _moveAt2[0];

	    var newHue = getHueByCoordinates(newX, width);
	    onChange(toColor("hsb", _objectSpread$1(_objectSpread$1({}, color.hsb), {}, {
	      h: newHue
	    })));
	  };
	  ...
	  var onMouseDown = function onMouseDown(e) {
	    if (hueRef.current) {
	      ...
	      if (e.button !== 0) return;
	      var hue = hueRef.current;
	      (_document$getSelectio = document.getSelection()) === null || _document$getSelectio === void 0 ? void 0 : _document$getSelectio.empty();

	      var _hue$getBoundingClien = hue.getBoundingClientRect(),
	          shiftX = _hue$getBoundingClien.left;
	...
	var UpperFloor = function UpperFloor(_ref) {
	  var color = _ref.color,
	      hideHEX = _ref.hideHEX,
	      onChange = _ref.onChange;
	  var getValueHEX = react.useCallback(function () {
	    return {
	      value: color.hex,
	      inputted: false
	    };
	  ...
	  var _useState = react.useState(getValueHEX),
	      _useState2 = _slicedToArray$1(_useState, 2),
	      valueHEX = _useState2[0],
	      setValueHEX = _useState2[1];
	  ...
	  var changeHEX = function changeHEX(e) {
	    var value = e.target.value;

	    if (isValidHEX(value)) {
	      onChange(toColor("hex", value));
	      setValueHEX(_objectSpread(_objectSpread({}, valueHEX), {}, {
	        value: value
	      }));
	    }
	  };
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
	    children: !hideHEX && /*#__PURE__*/jsxRuntime.jsx("div", {
	      className: "rcp-fields-floor",
	      children: /*#__PURE__*/jsxRuntime.jsxs("div", {
	        className: "rcp-fields-element",
	        children: [/*#__PURE__*/jsxRuntime.jsx("input", {
	          className: "rcp-fields-element-input",
	          value: valueHEX.value,
	          onFocus: function onFocus() {
	            return setValueHEX(_objectSpread(_objectSpread({}, valueHEX), {}, {
	              inputted: true
	            }));
	          },
	          onChange: changeHEX,
	          ...
	          className: "rcp-fields-element-label",
	          children: "HEX"
	        })]
	      })
	    })
	...
	var LowerFloor = function LowerFloor(_ref2) {
	  var color = _ref2.color,
	      hideRGB = _ref2.hideRGB,
	      hideHSB = _ref2.hideHSB,
	      onChange = _ref2.onChange;
	  var getValueRGB = react.useCallback(function () {
	    return {
	      value: "".concat(color.rgb.r, ", ").concat(color.rgb.g, ", ").concat(color.rgb.b),
	      inputted: false
	    };
	  }, [color.rgb]);
	  var getValueHSB = react.useCallback(function () {
	    return {
	      value: "".concat(Math.round(color.hsb.h), "\xB0, ").concat(Math.round(color.hsb.s), "%, ").concat(Math.round(color.hsb.b), "%"),
	      inputted: false
	    };
	  }, [color.hsb]);

	  var _useState3 = react.useState(getValueRGB),
	      _useState4 = _slicedToArray$1(_useState3, 2),
	      valueRGB = _useState4[0],
	      setValueRGB = _useState4[1];

	  var _useState5 = react.useState(getValueHSB),
	      _useState6 = _slicedToArray$1(_useState5, 2),
	      valueHSB = _useState6[0],
	      setValueHSB = _useState6[1];
	  ...
	  var changeRGB = function changeRGB(e) {
	    var value = e.target.value.match(/\d+/g);

	    if (value && value.length === 3) {
	      var rgb = toValidRGB(value.slice(0, 3));
	      onChange(toColor("rgb", rgb));
	    }

	    setValueRGB(_objectSpread(_objectSpread({}, valueRGB), {}, {
	      value: e.target.value
	    }));
	  };

	  var changeHSB = function changeHSB(e) {
	    var value = e.target.value.match(/\d+/g);

	    if (value && value.length === 3) {
	      var hsb = toValidHSB(value.slice(0, 3));
	      onChange(toColor("hsb", hsb));
	    }

	    setValueHSB(_objectSpread(_objectSpread({}, valueHSB), {}, {
	      value: e.target.value
	    }));
	  };

	  return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
	    children: (!hideRGB || !hideHSB) && /*#__PURE__*/jsxRuntime.jsxs("div", {
	      className: "rcp-fields-floor",
	      children: [!hideRGB && /*#__PURE__*/jsxRuntime.jsxs("div", {
	        className: "rcp-fields-element",
	        children: [/*#__PURE__*/jsxRuntime.jsx("input", {
	          className: "rcp-fields-element-input",
	          value: valueRGB.value,
	          onFocus: function onFocus() {
	            return setValueRGB(_objectSpread(_objectSpread({}, valueRGB), {}, {
	              inputted: true
	            }));
	          },
	          onChange: changeRGB,
	      ...
	      }), !hideHSB && /*#__PURE__*/jsxRuntime.jsxs("div", {
	        className: "rcp-fields-element",
	        children: [/*#__PURE__*/jsxRuntime.jsx("input", {
	          className: "rcp-fields-element-input",
	          value: valueHSB.value,
	          onFocus: function onFocus() {
	            return setValueHSB(_objectSpread(_objectSpread({}, valueHSB), {}, {
	              inputted: true
	            }));
	          },
	          onChange: changeHSB,
	...
	var Fields = function Fields(_ref3) {
	  var color = _ref3.color,
	      hideHEX = _ref3.hideHEX,
	      hideRGB = _ref3.hideRGB,
	      hideHSB = _ref3.hideHSB,
	      onChange = _ref3.onChange;
	  return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
	    children: (!hideHEX || !hideRGB || !hideHSB) && /*#__PURE__*/jsxRuntime.jsxs("div", {
	      className: "rcp-fields",
	      children: [/*#__PURE__*/jsxRuntime.jsx(UpperFloor, {
	        color: color,
	        hideHEX: hideHEX,
	        onChange: onChange
	      }), /*#__PURE__*/jsxRuntime.jsx(LowerFloor, {
	        color: color,
	        hideRGB: hideRGB,
	        hideHSB: hideHSB,
	        onChange: onChange
	...
	var ColorPicker = function ColorPicker(_ref) {
	  var width = _ref.width,
	      ...
	      color = _ref.color,
	      onChange = _ref.onChange,
	      _ref$hideHEX = _ref.hideHEX,
	      hideHEX = _ref$hideHEX === void 0 ? false : _ref$hideHEX,
	      _ref$hideRGB = _ref.hideRGB,
	      hideRGB = _ref$hideRGB === void 0 ? false : _ref$hideRGB,
	      _ref$hideHSB = _ref.hideHSB,
	      hideHSB = _ref$hideHSB === void 0 ? false : _ref$hideHSB,
	      _ref$dark = _ref.dark,
	      dark = _ref$dark === void 0 ? false : _ref$dark;
	  return /*#__PURE__*/jsxRuntime.jsxs("div", {
	    className: "rcp ".concat(dark ? "rcp-dark" : "rcp-light"),
	    style: {
	      width: width
	    },
	...
	function App() {
	  var _useColor = useColor("hex", "#121212"),
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("div", {
	    ...
	    children: /*#__PURE__*/jsxRuntime.jsx(ColorPicker, {
	      width: 456,
	      height: 228,
	      color: color,
	      onChange: setColor,
	...
	reactDom.render( /*#__PURE__*/jsxRuntime.jsx(react.StrictMode, {
